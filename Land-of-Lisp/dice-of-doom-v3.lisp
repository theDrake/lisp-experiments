;;;; dice-of-doom-v3.lisp (http://landoflisp.com/source.html)
;;;; Single-player, browser-based, graphical implementation of "Dice of Doom."
...
(defun draw-die-svg (x y col)
  (labels ((calc-pt (pt)
        (cons (+ x (* *dice-scale* (car pt))) (+ y (* *dice-scale* (cdr pt)))))
