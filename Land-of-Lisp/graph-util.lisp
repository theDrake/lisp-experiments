;;;; graph-util.lisp (http://landoflisp.com/source.html)
;;;; Library for interfacing with graphviz, letting you draw graphs from CLISP.
...
(defun dot->png (fname thunk)
  (with-open-file (*standard-output* (concatenate 'string fname ".dot")
