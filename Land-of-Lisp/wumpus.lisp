;;;; wumpus.lisp (http://landoflisp.com/source.html)
;;;; Implements a simple version of the classic "Hunt the Wumpus" game.
;;;;
;;;; Type "(new game)", then use "(walk #)" and "(charge #)" commands. Graphs
;;;; are written to "known-city.dot.png" which can be viewed in a browser and
;;;; refreshed after each move.
