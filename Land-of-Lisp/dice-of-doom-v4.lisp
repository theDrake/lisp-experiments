;;;; dice-of-doom-v4.lisp (http://landoflisp.com/source.html)
;;;; Multiplayer, browser-based, graphical implementation of "Dice of Doom."
;;;; Features larger board and richer overall experience.
              ...
              (if (and (not (eq (player dst) cur-player))
                ...
                (make-lazy (list (list (list src dst)
                      (game-tree (board-attack board cur-player src dst
                        ...
                        (+ spare-dice (dice dst))
                        nil)
                      (game-tree (board-attack-fail board cur-player src dst
                          (dice src))
                        cur-player
                        (+ spare-dice (dice dst))
                        nil))))
